...
class BreastfeedingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create breastfeeding" do
    assert_difference('Breastfeeding.count') do
      post breastfeedings_url, params: { breastfeeding: { cc-milk: @breastfeeding.cc-milk, day: @breastfeeding.day, time: @breastfeeding.time } }
    end
  ...
  test "should update breastfeeding" do
    patch breastfeeding_url(@breastfeeding), params: { breastfeeding: { cc-milk: @breastfeeding.cc-milk, day: @breastfeeding.day, time: @breastfeeding.time } }
